...
const SpecularButton = ({
  ...
  useEffect(() => {
    ...
    try {
      ...
      // Decorative-only effect — if WebGL2 is unavailable or the shader
      // fails to compile/link on some GPU/driver, the button still works
      // perfectly as a plain button, just without the specular sweep.
      console.error("SpecularButton: WebGL2 unavailable, skipping shine effect.", error);
      return;
    }
