...
// Decorative-only WebGL background (React Bits' "GhostFibers"). Purely
// visual — no data, no state, nothing here reads from or writes to the
// backend. Safe to remove or swap out without touching anything else.
