...
INSERT INTO "new_PaymentObligation" ("createdAt", "currency", "customerContact", "customerId", "dueDate", "id", "merchantId", "originalAmountPaise", "outstandingAmountPaise", "referenceId", "referenceType", "resolutionSource", "resolvedAt", "status") SELECT "createdAt", "currency", "customerContact", "customerId", "dueDate", "id", "merchantId", "originalAmountPaise", "outstandingAmountPaise", "referenceId", "referenceType", "resolutionSource", "resolvedAt", "status" FROM "PaymentObligation";
